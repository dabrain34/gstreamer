 ...
 * @GST_VULKAN_HANDLE_TYPE_VIDEO_SESSION: video session (Since: 1.24)
 * @GST_VULKAN_HANDLE_TYPE_VIDEO_SESSION_PARAMETERS: video session parameters (Since: 1.24)
 * @GST_VULKAN_HANDLE_TYPE_SAMPLER_YCBCR_CONVERSION: sampler with YCBCR conversion (Since: 1.24)
 *
 * Since: 1.18
 */
typedef enum
{
  ...
  /**
   * GST_VULKAN_HANDLE_TYPE_YCBCR_CONVERSION:
   *
