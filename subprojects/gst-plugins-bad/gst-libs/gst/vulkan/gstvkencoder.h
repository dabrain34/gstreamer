...
{
  union {
    VkVideoEncodeH264SessionParametersCreateInfoEXT   params_create;
  } h264;
};
...
gboolean                gst_vulkan_encoder_flush                (GstVulkanEncoder * self,
                                                                 GError ** error);
GST_VULKAN_API
gboolean                gst_vulkan_encoder_add_param            (GstVulkanEncoder * self,
                                                                 GstVulkanEncodePicture * pic,
                                                                 VulkanPackedHeaderType type,
                                                                 gpointer data,
                                                                 gsize size);
GST_VULKAN_API
